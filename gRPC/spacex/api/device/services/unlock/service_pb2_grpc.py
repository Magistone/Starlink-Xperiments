...
class UnlockService(object):
    ...
    def StartUnlock(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/SpaceX.API.Device.Services.Unlock.UnlockService/StartUnlock',
    ...
    def FinishUnlock(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/SpaceX.API.Device.Services.Unlock.UnlockService/FinishUnlock',
